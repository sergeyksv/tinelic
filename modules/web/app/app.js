	...
	return tb.Application.extend({
		...
		initRoutes: function (cb) {
			...
			require(routes, function (main, errors, details) {
				...
				router.get('/project/:slug/errors/:sort/:id', errors.client_errors);
				...
				router.get('/project/:slug/server_errors/:sort/:id', errors.server_errors);
				...
				router.get('/team/:teams/errors/:sort/:id', errors.client_errors);
				...
				router.get('/team/:teams/server_errors/:sort/:id', errors.server_errors);
