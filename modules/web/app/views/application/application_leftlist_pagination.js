define(['tinybone/base', 'lodash',"tinybone/backadapter","safe", 'dustc!views/application/application_leftlist_pagination.dust'],function (tb,_,api, safe) {
    var view = tb.View;
    var View = view.extend({
        id:"views/application/application_leftlist_pagination",
        events: {
    ...
    View.id = "views/application/application_leftlist_pagination";
    return View;
})
