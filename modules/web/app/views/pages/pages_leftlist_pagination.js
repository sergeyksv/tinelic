define(['tinybone/base', 'lodash',"tinybone/backadapter","safe", 'dustc!views/pages/pages_leftlist_pagination.dust'],function (tb,_,api, safe) {
    var view = tb.View;
    var View = view.extend({
        id:"views/pages/pages_leftlist_pagination",
        events: {
    ...
    View.id = "views/pages/pages_leftlist_pagination";
    return View;
})
