define(['tinybone/base','safe','tinybone/backadapter','dustc!views/project/errors.dust'],function (tb,safe,api) {
	var view = tb.View;
	var View = view.extend({
		id:"views/project/errors",
		postRender:function () {
