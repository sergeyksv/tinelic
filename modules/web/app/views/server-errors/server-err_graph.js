define(['tinybone/base', 'lodash',"tinybone/backadapter","safe",'highcharts', 'dustc!views/server-errors/server-err_graph.dust'],function (tb,_,api, safe) {
    var view = tb.View;
    var View = view.extend({
        id:"views/server-errors/server-err_graph",
        postRender:function () {
    ...
    View.id = "views/server-errors/server-err_graph";
    return View;
})
