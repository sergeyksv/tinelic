define(['tinybone/base', 'lodash',"tinybone/backadapter","safe",'highcharts', 'dustc!views/client-errors/err_graph.dust'],function (tb,_,api, safe) {
    var view = tb.View;
    var View = view.extend({
        id:"views/client-errors/err_graph",
        postRender:function () {
    ...
    View.id = "views/client-errors/err_graph";
    return View;
})
