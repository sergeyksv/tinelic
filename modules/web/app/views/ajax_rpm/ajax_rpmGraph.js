define(['tinybone/base','safe','tinybone/backadapter','highcharts','dustc!views/ajax_rpm/ajax_rpmGraph.dust','jquery.tablesorter.combined'],function (tb,safe,api) {
	var view = tb.View;
	var View = view.extend({
		id:"views/ajax_rpm/ajax_rpmGraph",
		postRender:function () {
	...
	View.id = "views/ajax_rpm/ajax_rpmGraph";
	return View;
})
