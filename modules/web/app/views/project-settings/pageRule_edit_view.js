define(['tinybone/base','safe','lodash','dustc!../../templates/project-settings/pageRule_edit.dust'],function (tb,safe,_) {
    var view = tb.View;
    var View = view.extend({
        id:"templates/project-settings/pageRule_edit",
        events: {
            'click .addAction': function(e) {
                var self = this;
                var $inc = self.$('#addPlaceHolder');
                require(["views/project-settings/pageRule_action_edit_view"],function(Action){
