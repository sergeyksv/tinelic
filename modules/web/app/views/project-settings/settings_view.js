define(['tinybone/base','lodash',"tinybone/backadapter",'safe','dustc!../../templates/project-settings/settings.dust'],function (tb,_,api,safe) {
    var view = tb.View;
    var View = view.extend({
        id:"templates/project-settings/settings",
        events: {
            ...
            "click .doEditRule":function(e){
                ...
                require(["views/project-settings/pageRule_edit_view"],function(PageRule){
    ...
    View.id = "views/project-settings/settings_view";
    return View;
})
